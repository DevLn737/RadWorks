...
- Extra Stage 3C spec-driven automated test hardening:
  ...
  - synchronized test docs/matrix with residual runtime gaps and explicit `SPEC_CODE_MISMATCH_CANDIDATE` markers;
  - no gameplay feature changes and no formula/mechanics rebalance.
